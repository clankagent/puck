...
const files = new Map([
 ['/playground/model.js',new URL('../playground/model.js',import.meta.url)],
 ['/',new URL('./index.html',import.meta.url)],['/storage.js',new URL('./storage.js',import.meta.url)],['/style.css',new URL('./style.css',import.meta.url)],['/settings.js',new URL('./settings.js',import.meta.url)],['/app.js',new URL('./app.js',import.meta.url)],['/recorder.js',new URL('./recorder.js',import.meta.url)],['/calibration-panel.js',new URL('./calibration-panel.js',import.meta.url)],
